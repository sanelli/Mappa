...
The registration method is generated by `[MappaDependencyInjection]` using `InjectFromAssemblies` to discover the hand-written `[Mappa]` mapper in the Bson package:
