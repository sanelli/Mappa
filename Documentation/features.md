...
| Enum | Enum-to-enum, enum-to-integral, enum-to-string, integral-to-enum, and string-to-enum. | [§4 Enum](./mappa-generator-algorithm.md#4-enum-strategy) | [EnumToEnumMapper.cs](../Mappa.Samples/EnumToEnumMapper.cs), [EnumToIntegralMapper.cs](../Mappa.Samples/EnumToIntegralMapper.cs), [EnumToStringMapper.cs](../Mappa.Samples/EnumToStringMapper.cs), [IntegralToEnumMapper.cs](../Mappa.Samples/IntegralToEnumMapper.cs), [StringToEnumMapper.cs](../Mappa.Samples/StringToEnumMapper.cs) |
