...
| Container | Arrays, spans, lists, sets, queues, stacks, concurrent, immutable, frozen, and custom collection implementations. `EnumerableConcreteType` selects `List<T>` or `T[]` buffers for sequence-like interface targets. | [§7 Container](./mappa-generator-algorithm.md#7-container-strategy) | [CollectionToCollectionMapper.cs](../Mappa.Samples/CollectionToCollectionMapper.cs), [EnumerableConcreteTypeMapper.cs](../Mappa.Samples/EnumerableConcreteTypeMapper.cs), [ReadOnlyTargetCollectionMapper.cs](../Mappa.Samples/ReadOnlyTargetCollectionMapper.cs) |
