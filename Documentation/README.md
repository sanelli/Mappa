...
## See also
- [Mappa algorithm](./mappa-generator-algorithm.md): description of how the algorithms works;
- [Mappa attributes](./mappa-attributes.md): description of the attributes that can impact the generation of the code;
- [Errors and warnings](./error-codes.md): list of errors and warnings that can be raised by the Mappa;
...
- [Development](./development.md): how to extend mappa functionalities;
- [NuGet](./development.md): list of NuGet packages provided;