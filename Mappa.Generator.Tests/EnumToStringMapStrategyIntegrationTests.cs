    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapEnumToStringByDescriptionOnMethod()
    {
        const string sourceCode = """
                                  #nullable enable
                                  using System.ComponentModel;
        ...
        generatedResults.Should()
            ...
            .HaveDefaultMapMethod(
                ...
                "Mappa.Generator.Tests.UnitTests.SourceCode.TestEnum",
                NullableAnnotation.NotAnnotated,
                AssertDescriptionEnumToStringSwitch);
    }

    /// <summary>
    /// Test enum-to-string mapping by Description configured via <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapEnumToStringByDescriptionInEditorConfig()
    {
    ...
    /// <c>.editorconfig</c> for enum-to-string mapping.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapEnumToStringWhenClassEnumStringMapSettingOverridesEditorConfig()
    {
        const string editorConfig = """
                                    root = true
        ...
        generatedResults.Should()
            ...
            .HaveDefaultMapMethod(
                ...
                "Mappa.Generator.Tests.UnitTests.SourceCode.TestEnum",
                NullableAnnotation.NotAnnotated,
                AssertMemberNameEnumToStringSwitch);
    }

    /// <summary>
    /// Test method-level <see cref="MappaSettingsAttribute.EnumStringMapSetting"/> overrides
    /// class-level and <c>.editorconfig</c> settings for enum-to-string mapping.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapEnumToStringWhenMethodEnumStringMapSettingOverridesClassAndEditorConfig()
    {
        const string editorConfig = """
                                    root = true
    ...
    private static void AssertDescriptionEnumToStringSwitch(BlockSyntaxAssertions blockSyntaxAssertions)
    {
        blockSyntaxAssertions
            .HasSyntaxNodesCount(3)
            .HasNextSyntaxNode(syntaxNodeAssertions =>
    ...
    private static void AssertMemberNameEnumToStringSwitch(BlockSyntaxAssertions blockSyntaxAssertions)
    {
        blockSyntaxAssertions
            .HasSyntaxNodesCount(3)
            .HasNextSyntaxNode(syntaxNodeAssertions =>
