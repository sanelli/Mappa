    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    /// <summary>
    /// Test map from <see cref="IEnumerable{T}"/> to <see cref="IReadOnlyList{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToIReadOnlyList()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial IReadOnlyList<string> Map(IEnumerable<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .NotBeNull().And
            .HaveDefaultMapMethod(
                typeof(IReadOnlyList<string>).ToString(),
                NullableAnnotation.NotAnnotated,
                typeof(IEnumerable<int>).ToString(),
                NullableAnnotation.NotAnnotated,
                blockSyntaxAssertions =>
    ...
    /// <summary>
    /// Test map from <see cref="Array"/> to <see cref="IReadOnlyList{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToIReadOnlyList()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial IReadOnlyList<string> Map(int[] input);
                                  }
