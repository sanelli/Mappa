    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    /// <summary>
    /// Test <see cref="AttributeDataExtensions.GetMappaSettingsAttribute"/> reads <see cref="MappaSettingsAttribute.PreventEnumerableCount"/>.
    /// </summary>
    [Fact]
    [UnitTest]
    public void GetMappaSettingsAttributeReadsPreventEnumerableCount()
    {
        const string source = """
                              using Mappa;
                              using Mappa.Attributes;
