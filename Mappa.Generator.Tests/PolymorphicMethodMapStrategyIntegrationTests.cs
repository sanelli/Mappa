    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    /// Test a mapping can use a polymorphic mappa-generated
    /// method where the types are defined by <see cref="MappaTypeMappingAttribute"/>.
    /// The method invoked is static.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingStaticCustomPolymorphicPartialMethodWhereMappingIsDefinedInTheMappingAttribute()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaTypeMapping(typeof(TargetFirst), typeof(SourceFirst))]
                                      public static partial TargetBase MapDependency(SourceBase input);
                ...
                blockSyntaxAssertions =>
                {
                    blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            ...
                            initializerAssertions => initializerAssertions.BeCastExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.TargetFirst",
                                expressionAssertions => expressionAssertions.BeInvocationExpressionUsingIdentifierNameSyntax(
                                    "MapDependency",
                                    parameterAssertions => parameterAssertions.BeIdentifierNameSyntax("__mappa_tmp_7")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
            ...
            .HaveDefaultMapMethod(
                ...
                blockSyntaxAssertions =>
                {
                    blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeReturnStatement("__mappa_tmp_12"));
                });
    }
    ...
    /// Test a mapping can use a polymorphic mappa-generated
    /// method where the types are defined by <see cref="MappaTypeMappingAttribute"/>.
    /// The invoked method is implemented by the user.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingCustomUserImplementedPolymorphicPartialMethodWhereMappingIsDefinedInTheMappingAttribute()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      ...
                                      {
                                           return input is SourceFirst ? new TargetFirst(){ } : new TargetBase(){ };
                                      }
    ...
    /// <summary>
    /// Test a mapping does not use a polymorphic mappa-generated
    /// method where the types are defined by <see cref="MappaTypeMappingAttribute"/>
    /// because the method being mapped is static but the polymorphic method is not static.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [Bug("#185")]
    [IntegrationTest]
    public async Task CanMapWithoutThePolymorphicMethodBeingPickedUpBecauseItIsNotStatic()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// method where the types are defined by <see cref="MappaTypeMappingAttribute"/>
    /// because the method being mapped is static but the polymorphic method is not static
    /// and obtained from a non-static property.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [Bug("#185")]
    [IntegrationTest]
    public async Task CanMapWithoutThePolymorphicMethodBeingPickedUpBecauseItIsNotStaticFromNonStaticPropertyDependency()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaTypeMapping(typeof(TargetFirst), typeof(SourceFirst))]
                                      public TargetBase MapDependency(SourceBase input) => null;
                                  }
                                  ...
                                  {
                                      [MappaDependency]
                                      private Dependency dependency { get; } = new Dependency();
                ...
                blockSyntaxAssertions =>
                {
                   blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            ...
                            initializerAssertions => initializerAssertions.BeObjectCreationExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.TargetFirst",
                                ("FirstProperty", propertyInitializerAssertions => propertyInitializerAssertions.BeIdentifierNameSyntax("__mappa_tmp_3")),
                                ("BaseProperty", propertyInitializerAssertions => propertyInitializerAssertions.BeIdentifierNameSyntax("__mappa_tmp_4")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                            "__mappa_tmp_6",
                            initializerAssertions => initializerAssertions.BeObjectCreationExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                                ("DependencyProperty", propertyInitializerAssertions => propertyInitializerAssertions.BeIdentifierNameSyntax("__mappa_tmp_5")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeReturnStatement(
    ...
    /// method where the types are defined by <see cref="MappaTypeMappingAttribute"/>
    /// because the method being mapped is static but the polymorphic method is not static
    /// and obtained from a non-static field.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [Bug("#185")]
    [IntegrationTest]
    public async Task CanMapWithoutThePolymorphicMethodBeingPickedUpBecauseItIsNotStaticFromNonStaticFieldDependency()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test a mapping can use a polymorphic mappa-generated method when
    /// <see cref="MappaSettingsAttribute.PolymorphicMapMethodWithMatchingDefaultAttribute"/> is
    /// enabled in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingCustomPolymorphicPartialMethodWhenPolymorphicMapMethodWithMatchingDefaultAttributeIsEnabledInEditorConfig()
    {
    ...
    /// <summary>
    /// Test class-level <see cref="MappaSettingsAttribute.PolymorphicMapMethodWithMatchingDefaultAttribute"/> disable overrides
    /// enable defined in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingCustomPolymorphicPartialMethodWhenPolymorphicMapMethodWithMatchingDefaultAttributeInEditorConfigIsOverriddenByClassAttributeAsDisable()
    {
        const string editorConfig = """
                                    root = true
