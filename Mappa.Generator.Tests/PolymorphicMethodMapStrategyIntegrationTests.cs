...
/// </summary>
// TODO [#49] Add tests to check we can pick up polymorphic method when mapping when types are defined in the MappaTypeMappingDefault attribute implicitly (via the usual mapMethod strategy and not the polymorphic one).
