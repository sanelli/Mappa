...
public sealed partial class CollectionToCollectionMapStrategyIntegrationTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToConcurrentCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToGenericTypeDerivedFromConcurrentCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToNonGenericTypeDerivedFromConcurrentCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
