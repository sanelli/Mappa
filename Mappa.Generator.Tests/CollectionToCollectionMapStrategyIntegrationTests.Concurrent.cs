// <copyright file="CollectionToCollectionMapStrategyIntegrationTests.Concurrent.cs" company="Stefano Anelli">
...
{
    /// <summary>
    /// Test map from <see cref="System.Collections.Concurrent.BlockingCollection{T}"/> to <see cref="List{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromBlockingCollectionToList()
    {
        // Arrange
        const string sourceCode = """
                                  ...
                                  {
                                      public partial List<string> Map(BlockingCollection<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .HaveDefaultMapMethod(
                ...
                typeof(System.Collections.Concurrent.BlockingCollection<int>).ToString(),
                NullableAnnotation.NotAnnotated,
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToBlockingCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial BlockingCollection<string> Map(IEnumerable<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .NotBeNull().And
            .HaveDefaultMapMethod(
                typeof(System.Collections.Concurrent.BlockingCollection<string>).ToString(),
                NullableAnnotation.NotAnnotated,
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToGenericTypeDerivedFromBlockingCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToNonGenericTypeDerivedFromBlockingCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test map from <see cref="List{T}"/> to
    /// <see cref="System.Collections.Concurrent.BlockingCollection{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToBlockingColletion()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial BlockingCollection<string> Map(List<int> input);
                                  }
    ...
    /// <summary>
    /// Test map from <see cref="List{T}"/> to a generic type derived from
    /// <see cref="System.Collections.Concurrent.BlockingCollection{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToGenericTypeDerivedFromBlockingColletion()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial Target<string> Map(List<int> input);
                                  }
    ...
    /// <summary>
    /// Test map from <see cref="List{T}"/> to a non-generic type derived from
    /// <see cref="System.Collections.Concurrent.BlockingCollection{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToNonGenericTypeDerivedFromBlockingColletion()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial Target Map(List<int> input);
                                  }
    ...
    /// <summary>
    /// Test map from <see cref="System.Collections.Concurrent.ConcurrentBag{T}"/> to <see cref="List{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromConcurrentBagToList()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial List<string> Map(ConcurrentBag<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .HaveDefaultMapMethod(
                typeof(List<string>).ToString(),
                NullableAnnotation.NotAnnotated,
                typeof(System.Collections.Concurrent.ConcurrentBag<int>).ToString(),
                NullableAnnotation.NotAnnotated,
                blockSyntaxAssertions =>
                {
                    blockSyntaxAssertions
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToConcurrentBag()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial ConcurrentBag<string> Map(IEnumerable<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .NotBeNull().And
            .HaveDefaultMapMethod(
                typeof(System.Collections.Concurrent.ConcurrentBag<string>).ToString(),
                NullableAnnotation.NotAnnotated,
                typeof(IEnumerable<int>).ToString(),
                NullableAnnotation.NotAnnotated,
                blockSyntaxAssertions =>
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToGenericTypeDerivedFromConcurrentBag()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToNonGenericTypeDerivedFromConcurrentBag()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToConcurrentBag()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial ConcurrentBag<string> Map(List<int> input);
                                  }
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToGenericTypeDerivedFromConcurrentBag()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToNonGenericTypeDerivedFromConcurrentBag()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
