...
public sealed partial class CollectionToCollectionMapStrategyIntegrationTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToBlockingCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToGenericTypeDerivedFromBlockingCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToNonGenericTypeDerivedFromBlockingCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test map from <see cref="System.Collections.Concurrent.IProducerConsumerCollection{T}"/>
    /// to <see cref="List{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIProducerConsumerCollectionToList()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial List<string> Map(IProducerConsumerCollection<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .HaveDefaultMapMethod(
                typeof(List<string>).ToString(),
                NullableAnnotation.NotAnnotated,
                typeof(System.Collections.Concurrent.IProducerConsumerCollection<int>).ToString(),
                NullableAnnotation.NotAnnotated,
                blockSyntaxAssertions =>
                {
                    blockSyntaxAssertions
    ...
    /// <summary>
    /// Test map from <see cref="IEnumerable{T}"/> to
    /// <see cref="System.Collections.Concurrent.IProducerConsumerCollection{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToIProducerConsumerCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial IProducerConsumerCollection<string> Map(IEnumerable<int> input);
                                  }
        ...
        generatedResults.Should()
            ...
            .NotBeNull().And
            .HaveDefaultMapMethod(
                typeof(System.Collections.Concurrent.IProducerConsumerCollection<string>).ToString(),
                NullableAnnotation.NotAnnotated,
                typeof(IEnumerable<int>).ToString(),
                NullableAnnotation.NotAnnotated,
                blockSyntaxAssertions =>
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromListToIProducerConsumerCollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      public partial IProducerConsumerCollection<string> Map(List<int> input);
                                  }
