    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    /// <summary>
    /// Test map from <see cref="Array"/> to a class derbied form <see cref="Queue{T}"/>
    /// when the capacity constructor is present and the
    /// <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/>
    /// is enabled on class.
    /// </summary>
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToQueueWithCapacityConstructorAndSettingsEnabledOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToQueueWithCapacityConstructorAndEmptyCOnstructorAndSettingsEnabledOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToQueueWithCapacityConstructorAndSettingsEnabledOnMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToQueueWithCapacityConstructorAndEmptyConstructorAndSettingsDisabledOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToQueueWithCapacityConstructorAndEmptyConstructorAndSettingsUndefinedOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test map from <see cref="IEnumerable{T}"/> to a
    /// class derived from <see cref="Queue{T}"/> with
    /// capacity constructor and <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/>
    /// enabled on the class.
    /// The capacity constructor will be used and
    /// <see cref="System.Linq.Enumerable.Count{T}(IEnumerable{T})"/> will
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToQueueWithCapacityConstructorWithSettingEnabled()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToQueueWithCapacityConstructorAndEmptyConstructorWithSettingEnabled()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToQueueWithEmptyConstructorWithSettingEnabled()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test map from <see cref="Array"/> to a class derbied form <see cref="BlockingCollection{T}"/>
    /// when the capacity constructor is present and the
    /// <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/>
    /// is enabled on class.
    /// </summary>
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToBlockingCollectionWithCapacityConstructorAndSettingsEnabledOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public partial class Target : BlockingCollection<string>
                                  {
                                      public Target(int capacity) { }
                                  }
    ...
    /// <summary>
    /// Test map from <see cref="Array"/> to <see cref="BlockingCollection{T}"/>
    /// when the capacity constructor and empty constructor is present and the
    /// <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/>
    /// is enabled on class.
    /// The capacity constructor will be selected.
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToBlockingCollectionWithCapacityConstructorAndEmptyCOnstructorAndSettingsEnabledOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToBlockingCollectionWithCapacityConstructorAndSettingsEnabledOnMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToBlockingCollectionWithCapacityConstructorAndEmptyConstructorAndSettingsDisabledOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToBlockingCollectionWithCapacityConstructorAndEmptyConstructorAndSettingsUndefinedOnClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test map from <see cref="IEnumerable{T}"/> to a
    /// class derived from <see cref="BlockingCollection{T}"/> with
    /// capacity constructor and <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/>
    /// enabled on the class.
    /// The capacity constructor will be used and
    /// <see cref="System.Linq.Enumerable.Count{T}(IEnumerable{T})"/> will
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToBlockingCollectionWithCapacityConstructorWithSettingEnabled()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToBlockingCollectionWithCapacityConstructorAndEmptyConstructorWithSettingEnabled()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToBlockingCollectionWithEmptyConstructorWithSettingEnabled()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test map from array to custom collection type using the capacity constructor
    /// when <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/> is enabled in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingCustomCollectionWithCapacityConstructorWhenContainerCapacityConstructorsIsEnabledInEditorConfig()
    {
        const string editorConfig = """
                                    root = true

                                    [*.cs]
                                    mappa.containercapacityconstructors = enable
                                    """;
    ...
    /// <summary>
    /// Test class-level <see cref="MappaSettingsAttribute.ContainerCapacityConstructors"/> disable overrides
    /// enable defined in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapToCustomCollectionUsingEmptyConstructorWhenContainerCapacityConstructorsInEditorConfigIsOverriddenByClassAttributeAsDisable()
    {
        const string editorConfig = """
                                    root = true
