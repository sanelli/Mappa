// <copyright file="StringToTimeSpanMapStrategyIntegrationTests.cs" company="Stefano Anelli">
...
/// <summary>
/// Integration tests for the <see cref="StringToTimeSpanMapStrategy"/>.
/// </summary>
public sealed class StringToTimeSpanMapStrategyIntegrationTests
    : MappaGeneratorAbstractUnitTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapStringToTimeSpan()
    {
        ...
        const string sourceCode = """
                                  ...
                                  {
                                      public partial TimeSpan Map(string input);
                                  }
                                  """;
