// <copyright file="PolymorphismMapStrategyIntegrationTests.DefaultAndNull.cs" company="Stefano Anelli">
...
public sealed partial class PolymorphismMapStrategyIntegrationTests
{
    ...
    /// <see cref="MappaTypeMappingDefaultAttribute"/> as
    /// <see cref="MappaTypeMappingDefaultBehavior.Default"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingPolymorphismAndDefaultToDefault()
    {
        // Arrange
                            ...
                            (labelAssertions, caseBodyAssertions) =>
                            {
                                ...
                                caseBodyAssertions[0].AsBlock()
                                    ...
                                    .HasNextSyntaxNode(statementAssertions => statementAssertions.BeAssignmentExpressionStatement(
                                        ...
                                        rightAssertions => rightAssertions.BeDefaultLiteralExpressionSyntax()))
                                    .HasNextSyntaxNode(statementAssertions => statementAssertions.BeBreakStatement());
                            }))
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingPolymorphismAndDefaultToNull()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeSwitchStatementSyntax(
                            ...
                            (labelAssertions, caseBodyAssertions) =>
                            {
                                ...
                                caseBodyAssertions[0].AsBlock()
                                    ...
                                    .HasNextSyntaxNode(statementAssertions => statementAssertions.BeAssignmentExpressionStatement(
                                        leftAssertions => leftAssertions.BeIdentifierNameSyntax("__mappa_tmp_1"),
                                        rightAssertions => rightAssertions.BeLiteralExpressionSyntax(null)))
                                    .HasNextSyntaxNode(statementAssertions => statementAssertions.BeBreakStatement());
                            }))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeReturnStatement(expressionAssertions => expressionAssertions.BeIdentifierNameSyntax("__mappa_tmp_1")));
                });
    ...
    /// <see cref="MappaTypeMappingAttribute"/> and
    /// <see cref="MappaTypeMappingDefaultAttribute"/> as
    /// <see cref="MappaTypeMappingDefaultBehavior.Default"/> but
    /// returns also a diagnostic because the specified type will not
    /// be used.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingPolymorphismAndDefaultToDefaultWithDiagnosticBecauseATypeIsSpecified()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      ...
                                      [MappaTypeMapping(typeof(TargetSecondDerivedClass), typeof(SourceSecondDerivedClass))]
                                      [MappaTypeMapping(typeof(TargetFirstDerivedClass), typeof(SourceFirstDerivedClass))]
                                      [MappaTypeMappingDefault(MappaTypeMappingDefaultBehavior.Default, typeof(string))]
                                      public partial TargetBaseClass Map(SourceBaseClass input);
                                  }
                                  """;
        ...
        generatedResults.Should()
            .HaveDiagnostics(1)
            .HaveDiagnostic(MappaDiagnosticDescriptors.MappaTypeMappingDefaultAttributeUnusedType)
            .HaveGeneratedSourceCode()
            .WithCompilationUnit()
            .NotBeNull().And
            .HaveDefaultMapMethod(
    ...
    /// <see cref="MappaTypeMappingAttribute"/> and
    /// <see cref="MappaTypeMappingDefaultAttribute"/> as
    /// <see cref="MappaTypeMappingDefaultBehavior.Null"/> but
    /// returns also a diagnostic because the specified type will not
    /// be used.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingPolymorphismAndDefaultToNullWithDiagnosticBecauseATypeIsSpecified()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      ...
                                      [MappaTypeMapping(typeof(TargetSecondDerivedClass), typeof(SourceSecondDerivedClass))]
                                      [MappaTypeMapping(typeof(TargetFirstDerivedClass), typeof(SourceFirstDerivedClass))]
                                      [MappaTypeMappingDefault(MappaTypeMappingDefaultBehavior.Null, typeof(string))]
                                      public partial TargetBaseClass Map(SourceBaseClass input);
                                  }
                                  """;
