    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    /// <summary>
    /// Test a mapping can be created when source property is optional and
    /// <see cref="MappaSettingsAttribute.ProtobufOptional"/> is enabled in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapWithSourceOptionalEnabledInEditorConfigTargetingConstructorWithParameter()
    {
        const string editorConfig = """
                                    root = true

                                    [*.cs]
                                    mappa.protobufoptional = enable
                                    """;
    ...
    /// <summary>
    /// Test class-level <see cref="MappaSettingsAttribute.ProtobufOptional"/> disable overrides
    /// enable defined in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapWithSourceOptionalInEditorConfigOverriddenByClassAttributeAsDisableTargetingConstructorWithParameter()
    {
        const string editorConfig = """
                                    root = true
