// <copyright file="LongToDateTimeOffsetMapStrategyTests.cs" company="Stefano Anelli">
...
/// <summary>
/// Tests for <see cref="LongToDateTimeOffsetMapStrategy"/>.
/// </summary>
public sealed class LongToDateTimeOffsetMapStrategyTests
    : MappaGeneratorAbstractUnitTests
{
    /// <summary>
    /// Test a mapping can be created when mapping a <see cref="long"/>
    /// to a <see cref="DateTimeOffset"/> object.
    /// </summary>
    /// <param name="type">The type being converted to DateTimeOffset.</param>
    ...
    [IntegrationTest]
    public async Task CanMapLongToDateTimeOffset(Type type)
    {
        ...
        var sourceCode = $$"""
                          ...
                          {
                              public partial DateTimeOffset Map({{type}} input);
                          }
                          """;
