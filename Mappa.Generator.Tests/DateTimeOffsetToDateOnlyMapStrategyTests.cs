// <copyright file="DateTimeOffsetToDateOnlyMapStrategyTests.cs" company="Stefano Anelli">
...
/// <summary>
/// Tests for <see cref="DateTimeOffsetToDateOnlyMapStrategy"/>.
/// </summary>
public sealed class DateTimeOffsetToDateOnlyMapStrategyTests
    : MappaGeneratorAbstractUnitTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapDateTimeOffsetToDateOnly()
    {
        ...
        const string sourceCode = """
                                  ...
                                  {
                                      public partial DateOnly Map(DateTimeOffset input);
                                  }
                                  """;
