// <copyright file="PolymorphismMapStrategyIntegrationTests.GenericAttributes.cs" company="Stefano Anelli">
...
/// <summary>
/// Integration tests for <see cref="PolymorphismMapStrategy"/> using the generic
/// <see cref="Mappa.Attributes.MappaTypeMappingAttribute{TTarget, TSource}"/> and
/// <see cref="Mappa.Attributes.MappaTypeMappingDefaultAttribute{TDefault}"/> forms.
/// </summary>
public sealed partial class PolymorphismMapStrategyIntegrationTests
{
    /// <summary>
    /// Test mapping works between classes using multiple generic
    /// <see cref="Mappa.Attributes.MappaTypeMappingAttribute{TTarget, TSource}"/> attributes
    /// and no <see cref="Mappa.Attributes.MappaTypeMappingDefaultAttribute"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingGenericPolymorphismAttributesAndDefaultDefaultBehavior()
    {
        // Arrange
        const string sourceCode = """
                                  ...
                                  {
                                      [MappaTypeMapping<TargetThirdDerivedClass, SourceThirdDerivedClass>]
                                      [MappaTypeMapping<TargetSecondDerivedClass, SourceSecondDerivedClass>]
                                      [MappaTypeMapping<TargetFirstDerivedClass, SourceFirstDerivedClass>]
    ...
    /// <summary>
    /// Test mapping works between classes using multiple generic
    /// <see cref="Mappa.Attributes.MappaTypeMappingAttribute{TTarget, TSource}"/> attributes and
    /// <see cref="Mappa.Attributes.MappaTypeMappingDefaultAttribute{TDefault}"/> for an explicit MapSourceType target.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingGenericPolymorphismAttributesAndMapToSourceTypeWithExplicitTargetType()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      ...
                                      [MappaTypeMapping<TargetSecondDerivedClass, SourceSecondDerivedClass>]
                                      [MappaTypeMapping<TargetFirstDerivedClass, SourceFirstDerivedClass>]
                                      [MappaTypeMappingDefault<AnotherTargetBaseClass>]
                                      public partial TargetBaseClass Map(SourceBaseClass input);
                                  }
                                  """;
