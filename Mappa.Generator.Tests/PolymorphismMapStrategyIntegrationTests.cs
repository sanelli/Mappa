...
// TODO [#49] Test with invoke method to behaviour with static method defined in mapper parent class.
// TODO [#49] Test failure with InvokeMapMethod + specific-type + NON-STATIC method.
...
// TODO [#49] Test with invoke method to behaviour with static method in mapper with incorrect input type.
    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    /// to static method in the same class.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingPolymorphismAndDefaultInvokeStaticMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <see cref="MappaTypeMappingDefaultAttribute"/>
    /// with <see cref="MappaTypeMappingDefaultBehavior.InvokeMethod"/>
    /// to non-static method in the same class.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapBetweenClassesUsingPolymorphismAndDefaultInvokeNonStaticMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
