    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingDefaultBehaviourIsUndefined()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      ...
                                      [MappaTypeMapping(typeof(TargetSecondDerivedClass), typeof(SourceSecondDerivedClass))]
                                      [MappaTypeMapping(typeof(TargetFirstDerivedClass), typeof(SourceFirstDerivedClass))]
                                      [MappaTypeMappingDefault(MappaTypeMappingDefaultBehavior.Undefined, typeof(string)]
                                      public partial TargetBaseClass Map(SourceBaseClass input);
                                  }
                                  """;
    ...
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMultipleMappaTypeMappingHaveTheSameSourceType()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaTypeMapping(typeof(TargetFirstDerivedClass), typeof(SourceFirstDerivedClass))]
                                      [MappaTypeMapping(typeof(TargetSecondDerivedClass), typeof(SourceFirstDerivedClass))]
                                      public partial TargetBaseClass Map(SourceBaseClass input);
                                  }
                                  """;
        ...
        generatedResults.Should()
            .HaveDiagnostics(1)
            .HaveDiagnostic(MappaDiagnosticDescriptors.MappaTypeMappingAttributeHaveTheSameSourceType, "Mappa.Generator.Tests.UnitTests.SourceCode.SourceFirstDerivedClass");
    }

    /// <summary>
    /// Test diagnostic is returned when <see cref="MappaTypeMappingAttribute"/>
    /// has the same source type of the method being mapped.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingAttributeHasTheSameSourceTypeOfTheMethodBeingMapped()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public sealed partial class Mapper
                                  {
                                      [MappaTypeMapping(typeof(TargetFirstDerivedClass), typeof(SourceBaseClass))]
                                      public partial TargetBaseClass Map(SourceBaseClass input);
                                  }
                                  """;
        ...
        generatedResults.Should()
            .HaveDiagnostics(1)
            .HaveDiagnostic(MappaDiagnosticDescriptors.MappaTypeMappingAttributeMapsSourceType, "Mappa.Generator.Tests.UnitTests.SourceCode.SourceBaseClass");
    }

    /// <summary>
    /// Test diagnostic is returned when <see cref="MappaTypeMappingAttribute"/>
    /// source type is not derived from source map method class type.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingAttributeSourceTypeDoesNotDeriveSourceTypeMapMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public class SourceFirstDerivedClass
                                  {
                                     public float FirstDerivedClassProperty {get; set;}
                                  }
    ...
    /// <summary>
    /// Test diagnostic is returned when <see cref="MappaTypeMappingAttribute"/>
    /// source type is not implementing the source map method class interface.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingAttributeSourceTypeDoesNotImplementSourceTypeOfMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test diagnostic is returned when <see cref="MappaTypeMappingAttribute"/>
    /// target type is not derived from target map method class type.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingAttributeTargetTypeDoesNotDeriveTargetTypeOfMapMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public class TargetFirstDerivedClass
                                  {
                                     public string FirstDerivedClassProperty {get; set;}
                                  }
    ...
    /// <summary>
    /// Test diagnostic is returned when <see cref="MappaTypeMappingAttribute"/>
    /// target type is not implementing the target map method class interface.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingAttributeTargetTypeDoesNotImplementTargetTypeOfMapMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task TestDiagnosticIsReturnedWhenMappaTypeMappingAttributeDefineAMappingThatCannotBeSatisfied()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public class TargetFirstDerivedClass : TargetBaseClass
                                  {
                                     public TargetFirstDerivedClass(int baseClassProperty, int anotherProperty)
                                     {
    ...
    /// <summary>
    /// Test a mapping can use a polymorphic method defined on a base class of the mapper.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingPolymorphicMethodFromMapperBaseClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test a mapping can use a polymorphic method defined on a base class of a dependency property type.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingPolymorphicMethodFromDependencyPropertyBaseClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaDependency]
                                      private readonly DerivedDependency DependencyProperty {get;} = new DerivedDependency();
                    ...
                    blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            ...
                            initializerAssertions => initializerAssertions.BeCastExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.TargetFirst",
                                expressionAssertions => expressionAssertions.BeInvocationExpressionSyntax(
                                    "this.DependencyProperty.MapDependency",
                                    parameterAssertions => parameterAssertions.BeIdentifierNameSyntax("__mappa_tmp_1")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                            "__mappa_tmp_3",
    ...
    /// <summary>
    /// Test a mapping can use a polymorphic method defined on a base class of a dependency field type.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingPolymorphicMethodFromDependencyFieldBaseClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaDependency]
                                      private readonly DerivedDependency dependencyField = new DerivedDependency();
                    ...
                    blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            ...
                            initializerAssertions => initializerAssertions.BeCastExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.TargetFirst",
                                expressionAssertions => expressionAssertions.BeInvocationExpressionSyntax(
                                    "this.dependencyField.MapDependency",
                                    parameterAssertions => parameterAssertions.BeIdentifierNameSyntax("__mappa_tmp_1")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                            "__mappa_tmp_3",
    ...
    /// <summary>
    /// Test a mapping can use a [MappaDependency] property declared on a mapper base class for polymorphic mapping.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingMappaDependencyPropertyFromMapperBaseClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaDependency]
                                      protected Dependency DependencyProperty { get; } = new Dependency();
                                  }
    ...
    /// <summary>
    /// Test a mapping can use a [MappaDependency] field declared on a mapper base class for polymorphic mapping.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingMappaDependencyFieldFromMapperBaseClass()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaDependency]
                                      protected Dependency dependencyField = new Dependency();
                                  }
    ...
    /// <summary>
    /// Test a private [MappaDependency] on a mapper base class is ignored for polymorphic mapping when inaccessible to the derived mapper.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task InaccessiblePrivateMappaDependencyOnMapperBaseClassIsIgnored()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                ...
                blockSyntaxAssertions =>
                {
                    blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            ...
                            "__mappa_tmp_2",
                            initializerAssertions => initializerAssertions.BeMemberAccessExpressionSyntax("__mappa_tmp_1.FirstProperty")))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            typeof(string).ToString(),
                            "__mappa_tmp_3",
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            typeof(int).ToString(),
                            "__mappa_tmp_4",
                            initializerAssertions => initializerAssertions.BeMemberAccessExpressionSyntax("__mappa_tmp_1.BaseProperty")))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            "Mappa.Generator.Tests.UnitTests.SourceCode.TargetFirst",
                            "__mappa_tmp_5",
                            initializerAssertions => initializerAssertions.BeObjectCreationExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.TargetFirst",
                                ("FirstProperty", expressionAssertions => expressionAssertions.BeIdentifierNameSyntax("__mappa_tmp_3")),
                                ("BaseProperty", expressionAssertions => expressionAssertions.BeIdentifierNameSyntax("__mappa_tmp_4")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                            "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                            "__mappa_tmp_6",
                            initializerAssertions => initializerAssertions.BeObjectCreationExpressionSyntax(
                                "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                                ("DependencyProperty", expressionAssertions => expressionAssertions.BeIdentifierNameSyntax("__mappa_tmp_5")))))
                        .HasNextSyntaxNode(syntaxNodeAssertions => syntaxNodeAssertions.BeReturnStatement(
