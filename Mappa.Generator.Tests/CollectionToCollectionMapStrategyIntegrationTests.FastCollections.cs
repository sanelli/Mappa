...
public sealed partial class CollectionToCollectionMapStrategyIntegrationTests
{
    ...
    /// <summary>
    /// Test map from <see cref="Array"/> to <see cref="IEnumerable{T}"/>
    /// with <see cref="MappaSettingsAttribute.FastCollections"/> enabled in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToIEnumerableWhenFastCollectionsIsEnabledInEditorConfig()
    {
        const string editorConfig = """
                                    root = true

                                    [*.cs]
                                    mappa.fastcollections = enable
                                    """;
    ...
    /// <summary>
    /// Test class-level <see cref="MappaSettingsAttribute.FastCollections"/> disable overrides
    /// enable defined in <c>.editorconfig</c>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToIEnumerableWhenFastCollectionsInEditorConfigIsOverriddenByClassAttributeAsDisable()
    {
        const string editorConfig = """
                                    root = true
