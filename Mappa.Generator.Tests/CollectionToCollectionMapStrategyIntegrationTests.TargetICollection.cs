// <copyright file="CollectionToCollectionMapStrategyIntegrationTests.TargetICollection.cs" company="Stefano Anelli">
...
public sealed partial class CollectionToCollectionMapStrategyIntegrationTests
{
    ...
    /// implementing <see cref="ICollection{T}"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToNonGenericTypeImplementingICollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToGenericTypeImplementingICollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToNonGenericTypeImplementingICollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromIEnumerableToGenericTypeImplementingICollection()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
