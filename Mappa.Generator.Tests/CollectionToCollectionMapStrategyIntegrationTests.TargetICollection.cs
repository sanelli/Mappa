...
public sealed partial class CollectionToCollectionMapStrategyIntegrationTests
{
    ...
    /// <summary>
    /// Test map from <see cref="Array"/> to non-generic type
    /// implementing <see cref="ICollection{T}"/> and the method <see cref="ICollection{T}.Add"/>
    /// is property defined in the derived class..
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapFromArrayToNonGenericTypeImplementingICollectionWithDefinedAddMethod()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
