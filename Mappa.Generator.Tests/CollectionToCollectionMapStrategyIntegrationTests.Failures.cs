...
public sealed partial class CollectionToCollectionMapStrategyIntegrationTests
{
    ...
    public async Task CannotMapTargetingCustomCollectionWithNonEmptyConstructor()
    {
        ...
        generatedResults.Should()
            .HaveDiagnostics(1)
            .HaveDiagnostic(MappaDiagnosticDescriptors.CannotIdentifyStrategy, "System.Collections.Generic.IEnumerable<int>", "Mappa.Generator.Tests.UnitTests.SourceCode.Target");
    }
