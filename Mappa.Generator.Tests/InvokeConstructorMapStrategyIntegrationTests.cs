    ...
    : MappaGeneratorAbstractUnitTests
{
                    ...
                    blockSyntaxAssertions
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
                            syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                                typeof(int).ToString(),
                                "__mappa_tmp_2",
                                initializationAssertions => initializationAssertions.BeMemberAccessExpressionSyntax("__mappa_tmp_1.PropertyA"));
                        })
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
                            syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                                typeof(string).ToString(),
                                "__mappa_tmp_3",
                                initializationAssertions => initializationAssertions.BeInvocationExpressionSyntax($"__mappa_tmp_2.{nameof(this.ToString)}"));
                        })
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
                            syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                                typeof(int).ToString(),
                                "__mappa_tmp_4",
                                initializationAssertions => initializationAssertions.BeMemberAccessExpressionSyntax("__mappa_tmp_1.PropertyB"));
                        })
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
                            syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                                ...
                                initializationAssertions =>
                                {
                                    initializationAssertions.BeObjectCreationExpressionSyntax(
                                        "Mappa.Generator.Tests.UnitTests.SourceCode.InnerTarget",
                                        ("PropertyA", initAssertions => initAssertions.BeIdentifierNameSyntax("__mappa_tmp_3")),
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
                            syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                                ...
                                initializationAssertions =>
                                {
                                    initializationAssertions.BeObjectCreationExpressionSyntax(
                                        "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                                        ("Property", initAssertions => initAssertions.BeIdentifierNameSyntax("__mappa_tmp_5")));
                                });
                        })
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingConstructorWithParameters()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test a mapping from two classes can happen using the
    /// constructor with no arguments and the target setter is internal.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestThatPropertiesWithInternalSettersAreACorrectlyMapped()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      public string PropertyA { get; set; }
                                      public long PropertyB { get; internal set; }
                                  }
    ...
    /// <summary>
    /// Test a mapping from two classes can happen using the
    /// constructor with no arguments and the target getter is internal.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestThatPropertiesWithInternalGettersAreACorrectlyMapped()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      public int PropertyA { get; set; }
                                      public int PropertyB { internal get; set; }
                                  }
    ...
    /// <summary>
    /// Test that properties with private setters are ignored.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestThatPropertiesWithPrivateSettersAreIgnored()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      public string PropertyA { get; set; }
                                      public long PropertyB { get; private set; }
                                  }
    ...
    /// <summary>
    /// Test that properties with private getters are ignored.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task TestThatPropertiesWithPrivateGettersAreIgnored()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test that mapping fails when mapping without.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task MapUsingEmptyConstructorCannotHappenWhenSourcePropertyHasPrivateGetter()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task MappingReturnsAWarningForEveryPropertyThatCannotBeMapped()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
