    ...
    : MappaGeneratorAbstractUnitTests
{
    ...
    [Fact]
    [IntegrationTest]
    public async Task MapUsingEmptyConstructorMappingFailsWhenMappaUsePropertyIsUsedMultipleTimesOnTheSameTargetProperty()
    {
        // Arrange
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingEmptyConstructorMappingConstructorAndMappaUseProperty()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingEmptyConstructorMappingWhenMappaUsePropertyIsUsedMultipleTimesOnDifferentTargetProperty()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    /// <summary>
    /// Test a mapping from two classes cannot happen using the
    /// constructor with arguments and multiple <see cref="MappaUsePropertyAttribute"/>
    /// targeting the same properties.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task MapUsingConstructorWithParametersMappingFailsWhenMappaUsePropertyIsUsedMultipleTimesOnTheSameTargetProperty()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  public class Target
                                  {
                                      public Target(string propertyA) { }
                                  }

                                  [Mappa]
                                  public sealed partial class Mapper
                                  {
                                      [MappaUseProperty("propertyA",nameof(Source.Foo))]
                                      [MappaUseProperty("propertyA","ABC)]
                                      public partial Target Map(Source input);
                                  }
                                  #nullable restore
                                  """;
    ...
    /// <summary>
    /// Test a mapping from two classes can happen using the
    /// constructor with arguments and <see cref="MappaUsePropertyAttribute"/>.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingConstructorWithParametersMappingConstructorAndMappaUseProperty()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                        ...
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
                            syntaxNodeAssertions.BeLocalDeclarationStatementSyntax(
                                ...
                                initializationAssertions =>
                                {
                                    initializationAssertions.BeObjectCreationExpressionSyntax(
                                        "Mappa.Generator.Tests.UnitTests.SourceCode.Target",
                                        firstParameterAssertions => firstParameterAssertions.BeIdentifierNameSyntax("__mappa_tmp_2"));
                                });
                        })
                        .HasNextSyntaxNode(syntaxNodeAssertions =>
                        {
    ...
    /// Test a mapping from two classes can happen using the
    /// constructor with arguments and <see cref="MappaUsePropertyAttribute"/>
    /// and the target name has different casing.
    /// </summary>
    /// <returns>The async task.</returns>
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingConstructorWithParametersMappingConstructorAndMappaUsePropertyWithDifferentTargetNameCasing()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
    ...
    [Fact]
    [IntegrationTest]
    public async Task CanMapUsingConstructorWithParametersMappingWhenMappaUsePropertyIsUsedMultipleTimesOnDifferentTargetProperty()
    {
        // Arrange
        const string sourceCode = """
                                  #nullable enable
                                  ...
                                  {
                                      [MappaUseProperty("propertyA",nameof(Source.Foo))]
                                      [MappaUseProperty("propertyB",nameof(Source.PropertyA))]
                                      public partial Target Map(Source input);
                                  }
                                  #nullable restore
                                  """;
