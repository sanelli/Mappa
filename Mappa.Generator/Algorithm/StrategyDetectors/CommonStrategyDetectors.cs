...
internal static class CommonStrategyDetectors
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var targetElementType = context.TargetType.GetElementType();
    ...
    internal static bool TryGetKeyAndValueStrategy(
            ...
            CancellationToken cancellationToken)
    {
        var (sourceKeyType, sourceKeyValueType) = context.SourceType.GetKeyAndValueTypes();
        var (targetKeyType, targetValueType) = context.TargetType.GetKeyAndValueTypes();
