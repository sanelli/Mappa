// <copyright file="NullableToNonNullableMapStrategy.cs" company="Stefano Anelli">
...
/// </summary>
internal sealed class NullableToNonNullableMapStrategy
    : IMapStrategy
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NullableToNonNullableMapStrategy"/> class.
    /// </summary>
    /// <param name="targetType">The target type.</param>
    /// <param name="sourceType">The source type.</param>
    /// <param name="innerStrategy">The strategy that map types encapsulated by the nullable types.</param>
    public NullableToNonNullableMapStrategy(
