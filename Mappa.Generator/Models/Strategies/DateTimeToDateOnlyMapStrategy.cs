    ...
    : IMapStrategy
{
    ...
    /// <inheritdoc/>
    public MappaAlgorithmRule Rule => MappaAlgorithmRule.DateTimeToDateOnly;

    /// <inheritdoc/>
    public IMappaStrategyBuilder GetBuilder() => new DateTimeToDateOnlyMapStrategyBuilder(this);
}