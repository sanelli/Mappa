// <copyright file="ReadonlyQueuePropertyMapStrategy.cs" company="Stefano Anelli">
...
/// <summary>
/// Strategy used when mapping to a queue property that
/// either does not have a setter or the setter is not accessible.
/// </summary>
/// <param name="targetProperty">The target property (a queue type).</param>
...
internal sealed class ReadonlyQueuePropertyMapStrategy(IPropertySymbol targetProperty, IPropertySymbol sourceProperty, MapStrategy elementStrategy)
    : MapStrategy(targetProperty.Type, sourceProperty.Type)
{
    ...
    internal override IMappaStrategyBuilder GetBuilder()
        => new ReadonlyQueuePropertyMapStrategyBuilder(this);
}