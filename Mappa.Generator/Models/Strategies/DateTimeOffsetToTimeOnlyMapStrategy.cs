    ...
    : IMapStrategy
{
    ...
    /// <inheritdoc/>
    public MappaAlgorithmRule Rule => MappaAlgorithmRule.DateTimeOffsetToTimeOnly;

    /// <inheritdoc/>
    public IMappaStrategyBuilder GetBuilder() => new DateTimeOffsetToTimeOnlyMapStrategyBuilder(this);
}