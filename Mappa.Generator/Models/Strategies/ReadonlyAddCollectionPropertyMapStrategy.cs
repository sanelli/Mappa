// <copyright file="ReadonlyAddCollectionPropertyMapStrategy.cs" company="Stefano Anelli">
...
/// <summary>
/// Strategy used when mapping to a collection property that supports <c>Add</c>
/// and either does not have a setter or the setter is not accessible.
/// </summary>
...
internal sealed class ReadonlyAddCollectionPropertyMapStrategy(IPropertySymbol targetProperty, IPropertySymbol sourceProperty, MapStrategy elementStrategy)
    : MapStrategy(targetProperty.Type, sourceProperty.Type)
{
    ...
    internal override IMappaStrategyBuilder GetBuilder()
        => new ReadonlyAddCollectionPropertyMapStrategyBuilder(this);
}