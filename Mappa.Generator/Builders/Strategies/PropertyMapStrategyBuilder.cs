    ...
    : IMappaStrategyBuilder
{
    ...
    public (string VariableName, string Code) BuildSource(string source, MappaBuilderContext context, MappaGlobalOptions mappaGlobalOptions)
    {
        ...
        (string variableName, string value) = this.strategy.PropertyStrategy.GetBuilder().BuildSource(sourcePropertyTemporary, context, mappaGlobalOptions);
        ...
        return (variableName, builder.ToString());
    }
}