// <copyright file="CompatibleMethodMapStrategyBuilder.cs" company="Stefano Anelli">
...
/// <summary>
/// Builder for <see cref="CompatibleMethodMapStrategy"/>.
/// </summary>
internal sealed class CompatibleMethodMapStrategyBuilder(CompatibleMethodMapStrategy strategy)
    : IMappaStrategyBuilder
{
    private readonly CompatibleMethodMapStrategy strategy = strategy;
